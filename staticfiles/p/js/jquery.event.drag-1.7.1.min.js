...
//				$(".modal").fadeOut();
                ...
                var error_log = error_log = "<button type='button' class='btn_Close' onclick='popClose2()'></button><p></p><span>Error</span>";
                error_log = error_log.replace("Error", data.responseJSON.error);
                console.log(data.responseJSON.error);
